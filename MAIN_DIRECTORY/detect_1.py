        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    # print("xywh ==> ",xywh, " || conf ==> ", conf, " || class ==> ", names[int(cls)])
                    # print("xyxy ==> ", xyxy)
                    ...
                    #     # cv2.resizeWindow(str(p), im0.shape[1], im0.shape[0])
                    #     # im2 = im0[y:y+h, x:x+w]
                    #     # cv2.imwrite("car_"+str(conf), im2)
                    #     # cv2.waitKey(1)
                    #     # cv2.rectangle(im0, (x, y), (x+w, y+h), (0, 255, 0), 2)
                    #     box = xyxy
                    #     annotator.box_label(xyxy, names[int(cls)], color=(0,0,255))
                    # else:
                    #     annotator.box_label(xyxy, names[int(cls)], color=(0,255,0))
                        
                        # p1, p2 = (int(box[0]), int(box[1])), (int(box[2]), int(box[3]))
                        # cv2.rectangle(im0, p1, p2, (0,255,0), thickness=2, lineType=cv2.LINE_AA)
                        # outside = box[1] - h >= 0
                        # cv2.putText(im0,
                        #     names[int(cls)], (p1[0], p1[1] - 2 if outside else p1[1] + h + 2),
                        #     0,
                        #     3 / 3,
                        #     (255, 255, 255),
                        #     thickness=1,
                    ...
                    #     # print(label) # ============ labels of vehicles
